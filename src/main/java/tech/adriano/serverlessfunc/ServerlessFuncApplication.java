package tech.adriano.serverlessfunc;
...
public class ServerlessFuncApplication {
	...
	@Bean
	public Function<String, Boolean> isValidEmail() {
		return value -> {
	...
	public static void main(String[] args) {
		SpringApplication.run(ServerlessFuncApplication.class, args);
	}
}
